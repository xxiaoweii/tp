...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" feature allows user to add up to five different details of a person, including the name, role the person,\ncontact details, the course the person is taking, as well as the respective tutorial classes.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("When adding a profile, the only compulsory field that user has to include is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(" field.")]),_v(" "),_c('li',[_v("All the other fields "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("role")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("course")]),_v(" are optional.")]),_v(" "),_c('li',[_v("The fields can be added in any order.")]),_v(" "),_c('li',[_v("Users can have more than one input for each of the optional field.")]),_v(" "),_c('li',[_v("When adding a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("course")]),_v(", users can also choose to include or not to include the tutorial classes of the course.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v("feature allows user to get the information (name, role,\ncontact details, courses, tutorial classes) of all the people stored.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("the list feature is executed using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"favourite-feature"}},[_v("Favourite feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#favourite-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The favourite feature allows the user to favourite persons that they want to view more often so that they can\nview their favourited people easily by calling the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favlist")]),_v(" command.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The favourite feature is implemented using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Favourite")]),_v(" class. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Favourite")]),_v(" class contains a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("boolean")]),_v(" field\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isFavourite")]),_v(" to indicate whether the person is a favourite.")]),_v(" "),_c('li',[_v("When user calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("fav INDEX")]),_v(" "),_c('em',[_v("(the index is a positive integer the person has in the list)")]),_v(", the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isFavourite")]),_v(" field\nof the person will be set to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("true")]),_v(".")]),_v(" "),_c('li',[_v("When the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isFavourite")]),_v(" boolean is true, the current Person will be set to a new Person using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setPerson")]),_v(" method,\nto be set to a new favourited Person with all the same fields as the current Person, except that the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isFavourite")]),_v(" field\nis true. This is to ensure that the yellow favourite tag in the UI is shown.")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"favourite-list-feature"}},[_v("Favourite List feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#favourite-list-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"implementation-details-and-amp-philosophy"}},[_v("Implementation Details & Philosophy"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-details-and-amp-philosophy","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The favourite list feature is executed using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favlist")]),_v(" command.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("FavList Command")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("A FavListCommand Java class that extends the parent Command class will be created. This base class\nwill represent the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favlist")]),_v(" command")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Command Word")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Usage Message")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("A usage message constant MESSAGE_USAGE will be created to explain to the users how to interact and\nuse the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favlist")]),_v(" command")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Integration with Model")]),_v("\nTo ensure that the FavListCommand class interacts with the application's model\nto perform actions related to the favorite list. This will be done through the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.updateFilteredPersonList(predicate)")]),_v(" method.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('b',[_v("User Expectations:")]),_v(" "),_c('span',[_v("\nUsers have a common expectation that their favorited people should be accessible\nand manageable in a straightforward manner. Hence, this is fulfilled using a simple and intuitive\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favlist")]),_v(" command.\n")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"search-feature"}},[_v("Search feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#search-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"implementation-details-and-amp-philosophy-2"}},[_v("Implementation Details & Philosophy"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-details-and-amp-philosophy-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The search feature contains 4 different sub commands namely : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchrole")]),_v(",\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchcourse")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchtutorial")]),_v(" .")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search")]),_v(" allows the user to search for a person through their name")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchrole")]),_v(" allows the user to search for a list of people with the same role")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchcourse")]),_v(" allows the user to search for a list of people taking a particular course")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchtutorial")]),_v(" allows the user to search for a list of people taking a particular tutorial")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("search")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchrole")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchcourse")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("searchtutorial")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The autocomplete feature relies on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Map")]),_v(" from Command Words to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CheckedFunction")]),_v(" in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser.java")]),_v(" named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("wordToCommandMap")]),_v(". On instantiation, this "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Map")]),_v(" is populated with each Command Word as keys, and their respective values as lambda "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CheckedFunction")]),_v("s taking in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" userInput as arguments and returning a parsed version of their respective function. For example, a short excerpt is shown below;")])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs java"}},[_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("/**")]),_v("\n")]),_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v(" * Initialize the word to command map. Remember each command word maps to a lambda function")]),_v("\n")]),_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v(" * that will return the parsed Command object. This command object will then be executed.")]),_v("\n")]),_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v(" */")]),_v("\n")]),_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-function"}},[_c('span',{pre:true,attrs:{"class":"hljs-keyword"}},[_v("public")]),_v(" "),_c('span',{pre:true,attrs:{"class":"hljs-title"}},[_v("AddressBookParser")]),_c('span',{pre:true,attrs:{"class":"hljs-params"}},[_v("()")]),_v(" ")]),_v("{\n")]),_c('span',[_v("    "),_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// Command taking in arguments")]),_v("\n")]),_c('span',[_v("    wordToCommandMap.put(AddCommand.COMMAND_WORD, (arguments) -> "),_c('span',{pre:true,attrs:{"class":"hljs-keyword"}},[_v("new")]),_v(" AddCommandParser().parse(arguments));\n")]),_c('span',[_v("    "),_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// Command taking in no arguments; no need to parse via parser")]),_v("\n")]),_c('span',[_v("    wordToCommandMap.put(ClearCommand.COMMAND_WORD, (arguments) -> "),_c('span',{pre:true,attrs:{"class":"hljs-keyword"}},[_v("new")]),_v(" ClearCommand());\n")]),_c('span',[_v("    "),_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// ...")]),_v("\n")]),_c('span',[_v("}\n")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Once all the command words are stored in the map, the autocomplete feature will, on key pressed in the command box, check for any command that starts with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" input supplied by the user, and iterate through them one by one. In essence, the sequence of events is illustrated by the following activity diagram:")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('b',[_v("Performance and Scalability:")]),_v(" "),_c('span',[_v("\nIn order for autocomplete to be used with many commands, a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HashMap")]),_v(" implementation was chosen for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v("'s command word storage data structure as lookup for command words can be done in approximately "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("O(1)")]),_v(" time.\n")])]),_v(" "),_c('li',[_c('b',[_v("Consistency:")]),_v(" "),_c('span',[_v("\nTo maintain consistency with users' expectations of how Autocomplete features work, the exact mechanics (ie pressing Tab to cycle through command suggestions) are inspired by some traditional terminals' command autocomplete features, which are similar (for instance, Powershell's default autocomplete works similarly). Thus, users do not have to learn a new mental model for how they would expect the autocomplete to function.\n")])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"proposed-edit-feature"}},[_v("[Proposed] Edit feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-edit-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("API")]),_v(": Application Programming Interface, a set of rules and protocols that allow different software applications to communicate with each other")]),_v(" "),_c('li',[_c('strong',[_v("Architecture Diagram")]),_v(": Visual representation that illustrates how various components of the software project are structured and interconnected")]),_v(" "),_c('li',[_c('strong',[_v("JavaFX UI")]),_v(": A user interface framework in Java for creating interactive and visually appealing desktop applications")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, OS-X")]),_v(" "),_c('li',[_c('strong',[_v("PlantUML")]),_v(": A text-based tool for creating diagrams using simple text descriptions")]),_v(" "),_c('li',[_c('strong',[_v("Sequence Diagram")]),_v(": A visual tool showing the order of actions between system components or objects")]),_v(" "),_c('li',[_c('strong',[_v("Object-oriented paradigm")]),_v(":A programming paradigm")]),_v(" "),_c('li',[_c('strong',[_v("Profile")]),_v(": Information or details of a person, including their name, role, contact details, courses, tutorial classes, etc.")]),_v(" "),_c('li',[_c('strong',[_v("Manual testing")]),_v(": The process of testing the application through manual execution of specific test cases.")]),_v(" "),_c('li',[_c('strong',[_v("Logic Component")]),_v(": The component responsible for executing commands and coordinating interactions between different parts of the application.")]),_v(" "),_c('li',[_c('strong',[_v("Model Component")]),_v(": The part of the application that stores and manages the data, including the address book and user preferences.")]),_v(" "),_c('li',[_c('strong',[_v("Storage Component")]),_v(": The part of the application that handles reading and writing data.")])])}
},function anonymous(
) {
